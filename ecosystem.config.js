module.exports = {
    apps: [{
        name: 'MMusic',      //应用名
        script: 'dist/index.html',   //应用文件位置
        env: {
            PM2_SERVE_PATH: ".",    //静态服务路径
            PM2_SERVE_PORT: 3008,   //静态服务器访问端口
    ...
    deploy: {
        production: {
            ...
            repo: 'git@github.com:bigzjk/MMusic.git',   //git地址
            path: '/var/www/production',       //服务器文件路径
            'post-deploy': 'npm install && npm run build && pm2 reload ecosystem.config.js --env production'  //部署后的动作
        },  
        dev : {
            user : "root",
            host : "47.98.165.188",
